...
# 执行PyTorch分布式训练命令
srun bash -c "torchrun --nproc_per_node=2 --nnodes=1 --node_rank=\$SLURM_NODEID --master_addr=$MASTER_ADDR --master_port=29500 finetune_zl.py --model_path='./tx_pretrain.pth' --epoch='10' --data_path='./data/Zheng68K.h5ad'"
